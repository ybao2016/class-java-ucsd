...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		/*		
		Geographic coordinates of Hillsboro, Oregon, USA

		Latitude: 45°31′22″ N 
		Longitude: 122°59′23″ W 
		Elevation above sea level: 59 m = 193 ft
		Coordinates of Hillsboro in decimal degrees

		Latitude: 45.5228900	
		Longitude: -122.9898300
		Coordinates of Hillsboro in degrees and decimal minutes

		Latitude: 45°31.3734′ N	
		Longitude: 122°59.3898′ W
		 */
		//map2.zoomAndPanTo(zoomLevel, new Location(45.5f, -122.9f));
		
		
		// The next line zooms in and centers the map at 
	    // my home, Shanghai @31.1 (latitude) and 121.4 (longitude)
		//Shanghai
	    map2.zoomAndPanTo(zoomLevel, new Location(31.1f, 121.4f));
